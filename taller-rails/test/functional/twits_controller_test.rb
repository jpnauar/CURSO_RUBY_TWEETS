...
class TwitsControllerTest < ActionController::TestCase
  ...
  test "should create twit" do
    assert_difference('Twit.count') do
      post :create, :twit => { :id_twit => @twit.id_twit, :link_text => @twit.link_text, :links => @twit.links, :text => @twit.text, :trend => @twit.trend }
    end
  ...
  test "should update twit" do
    put :update, :id => @twit, :twit => { :id_twit => @twit.id_twit, :link_text => @twit.link_text, :links => @twit.links, :text => @twit.text, :trend => @twit.trend }
    assert_redirected_to twit_path(assigns(:twit))
  end
